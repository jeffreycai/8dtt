...
<div class="item-list">
  <ul class="pagination" style="text-align: left;">
    <?php if ($need_dot_on_left): ?>
      <li class="pager-previous"><a href="<?php echo update_query_string(array('page' => $page - 1)); ?>"><i class="glyphicon glyphicon-chevron-left"></i></a></li>
    ...
    <?php if ($need_dot_on_right): ?>
      ...
      <?php endfor; ?>
      <li class="pager-ellipsis"><a href="javascript:void(0)">...</a></li>
      <li class="pager-next"><a href="<?php echo update_query_string(array('page' => $page + 1)); ?>"><i class="glyphicon glyphicon-chevron-right"></i></a></li>
    <?php else: ?>
